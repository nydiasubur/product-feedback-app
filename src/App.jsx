          ...
          <section className="main">
            ...
            <div className="row add-feedback-header ">
              <div className="col-9 d-flex  align-items-center">
                ...
                <div className="mx-5 fw-bolder"> 6 Suggestions</div>
                <div>
                  <label for="sort-category">
                    <span className="fw-light">Sort by:</span>
                  </label>
                  <select
            ...
            <section className="">
              <div className="row feedback-card mt-3 mb-3 p-4">
                <div className="col-1 mx-2 d-flex upvote-button-section flex-column align-items-center">
                  ...
                  <div className="upvote-count">112</div>
                </div>
                <div className="col-9 ">
                  <h3 className="semi-bold-font-style">
                    {" "}
                    Add tags for solutions {/*feedback title*/}
                  </h3>
                  <p>
                  ...
                  <div>
                    <div className="category-button">Enhancement</div>
                  </div>
                </div>
                <div className="col-2">
                  <span>
                  ...
                  <span className="semi-bold-font-style">2</span>
                </div>
              </div>
            </section>
            {/*</FeedbackCard>*/}
